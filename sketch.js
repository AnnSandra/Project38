...
function setup() {
  ...
  trex = createSprite(50,displayHeight-150,20,50);
  ...
  ground.x = displayWidth/2-200;
 ground.velocityX = -(6 + 3*score/100);
  
  gameOver = createSprite(displayWidth/2-700,displayHeight/2);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(displayWidth/2-700,displayHeight/2+40);
...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   ground.velocityX = -(6 + 3*score/100);
    ...
    camera.position.y=displayHeight-150;
